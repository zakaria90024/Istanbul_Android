package com.copypasteit.istanbul.ViewActivity;
...
public class ViewActivity extends AppCompatActivity {
    ...
    private void getDataFromIntent() {
        ...
        String dress_slug = getIntent().getStringExtra("dress_model_no");
        ...
        setDataFromIntent(dress_name, dress_slug, dress_size, dress_image_url, dress_details);

    }

    private void setDataFromIntent(String dress_name, String dress_slug, String dress_size, String dress_image_url, String dress_details) {
        ...
        PostCategory.setText(dress_slug);
